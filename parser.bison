...
%type <type> type_func type_param type_var
...
/* decl_func: IDENTIFIER COLON FUNCTION type_func OPEN_PAREN param_list_e CLOSE_PAREN EQUALS OPEN_CURLY stmt_list CLOSE_CURLY { $$ = decl_create($1, $4, NULL, $10, $6); } */
         /* | IDENTIFIER COLON FUNCTION type_func OPEN_PAREN param_list_e CLOSE_PAREN SEMICOLON { $$ = decl_create($1, $4, NULL, NULL, NULL); } */
         ;
